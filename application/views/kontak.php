...
<div class="super_container">
	...
	<div class="home">
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src="<?php echo base_url('themepengunjung/') ?>images/contact.png"></div>
				...
				<div class="col">
					...
					<div class="contact_form_container">
						...
						<form action="#" id="contact_form" class="contact_form text-center">
							...
							<button type="submit" id="form_submit_button" class="form_submit_button button trans_200">send<span></span><span></span><span></span></button>
						</form>
					</div>
					...
					<div class="footer_col">
						<div class="footer_content footer_about">
							<div class="logo_container footer_logo">
								<div class="logo"><a href="#"><img src="<?php echo base_url('themepengunjung/') ?>images/logo.png" alt="">CONTACT</a></div>
							</div>
							<p class="footer_about_text">Sistem informasi </p>
...
<script src="<?php echo base_url('themepengunjung/') ?>https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyCIwF204lFZg1y4kPSIhKaHEXMLYxxuMhA"></script>
