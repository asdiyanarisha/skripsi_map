...
<div class="super_container">
				...
				<div class="row">
					<div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
						<div class="logo_container">
							<div class="logo"><a href="#"><img src="<?php echo base_url('themepengunjung') ?>/images/logo.png" alt="">travelix</a></div>
						</div>
	...
	<div class="home">
		...
		<div class="home_content">
			<div class="home_title">Pemetaan</div>
		</div>
	</div>
					...
					<div class="footer_col">
						...
						<div class="footer_content footer_blog">
							...
							<div class="footer_blog_item clearfix">
								<div class="footer_blog_image"><img src="<?php echo base_url('themepengunjung') ?>/images/footer_blog_1.jpg" alt="https://unsplash.com/@avidenov"></div>
							...
							<!-- Footer blog item -->
							<div class="footer_blog_item clearfix">
								<div class="footer_blog_image"><img src="<?php echo base_url('themepengunjung') ?>/images/footer_blog_2.jpg" alt="https://unsplash.com/@deannaritchie"></div>
								<div class="footer_blog_content">
							...
							<!-- Footer blog item -->
							<div class="footer_blog_item clearfix">
								<div class="footer_blog_image"><img src="<?php echo base_url('themepengunjung') ?>/images/footer_blog_3.jpg" alt="https://unsplash.com/@bergeryap87"></div>
								<div class="footer_blog_content">
									<div class="footer_blog_title"><a href="blog.html">Travel with us this year</a></div>
									<div class="footer_blog_date">Nov 29, 2017</div>
								</div>
						...
						<div class="footer_content footer_contact">
							<ul class="contact_info_list">
								<li class="contact_info_item d-flex flex-row">
									<div><div class="contact_info_icon"><img src="<?php echo base_url('themepengunjung') ?>/images/placeholder.svg" alt=""></div></div>
									<div class="contact_info_text">4127 Raoul Wallenber 45b-c Gibraltar</div>
								</li>
								<li class="contact_info_item d-flex flex-row">
									<div><div class="contact_info_icon"><img src="<?php echo base_url('themepengunjung') ?>/images/phone-call.svg" alt=""></div></div>
									<div class="contact_info_text">2556-808-8613</div>
								</li>
								<li class="contact_info_item d-flex flex-row">
									<div><div class="contact_info_icon"><img src="<?php echo base_url('themepengunjung') ?>/images/message.svg" alt=""></div></div>
									<div class="contact_info_text"><a href="mailto:contactme@gmail.com?Subject=Hello" target="_top">contactme@gmail.com</a></div>
								</li>
								<li class="contact_info_item d-flex flex-row">
									<div><div class="contact_info_icon"><img src="<?php echo base_url('themepengunjung') ?>/images/planet-earth.svg" alt=""></div></div>
